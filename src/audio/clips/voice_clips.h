...
extern "C" {
#endif
extern const int16_t clip_three[];
extern const unsigned clip_three_len;
extern const int16_t clip_two[];
extern const unsigned clip_two_len;
extern const int16_t clip_one[];
...
extern const int16_t clip_spin[];
extern const unsigned clip_spin_len;
extern const int16_t clip_over[];
extern const unsigned clip_over_len;
